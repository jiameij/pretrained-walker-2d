...
def main():
    ...
    parser.add_argument('--dirs', help='List of log directories', nargs = '*', default=['/home/jmj/baselines/baselines/ppo1/log'])
    parser.add_argument('--num_timesteps', type=int, default=int(1e9))
    parser.add_argument('--xaxis', help = 'Varible on X-axis', default = X_TIMESTEPS)
    parser.add_argument('--task_name', help = 'Title of plot', default = 'reward')
